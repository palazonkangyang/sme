<img src="{{ url("adforest/images/logo.png") }}"/>
<div style="border: 1px solid #ddd; padding: 10px">
    <h2 style="text-align: center; color: #0B8A4A; text-decoration: underline">Buyer Account Created</h2>

    <p>Hello {!! $buyer->contact_person !!},</p>
    ...
    <p>You may begin using buyer account by clicking on <a href="{!! Route("buyer.login") !!}">this link</a> and
        the
