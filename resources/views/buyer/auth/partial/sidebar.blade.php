    ...
    <div class="col-md-4 col-sm-12 col-xs-12 leftbar-stick blog-sidebar">
        ...
        <div class="user-profile">
            ...
            <ul>
                ...
                <li><a href="{{ route('buyer.auth.profile.active') }}">My Ads <span class="badge">{{ $my_ads }}</span></a></li>
                <li><a href="{{ route('buyer.auth.profile.wishlist') }}">Wish Lists <span class="badge">{{ $my_wishlists }}</span></a></li>
                <li><a href="{{ route('buyer.auth.profile.archieve') }}">Archives<span class="badge">{{ $my_archives }}</span></a></li>
                <li><a href="{{ route('buyer.auth.profile.blog') }}">Blog<span class="badge">{{ $my_blog }}</span></a></li>
