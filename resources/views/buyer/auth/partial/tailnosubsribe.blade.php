         ...
         <footer class="footer-area">
                        ...
                        <div class="row clearfix">
                           <div class="col-lg-7 col-sm-6 col-xs-12 column">
                              <div class="footer-widget about-widget">
                                 <div class="logo">
                                    <a href=""><img alt="" class="img-responsive"  src="{{ url("/adforest/images/logo-1.png") }}"></a>
                                 </div>
                                 <div class="text">
                                 ...
                                 <ul class="contact-info">
                                    <li><span class="icon fa fa-map-marker"></span>  Address: 21 Bukit Batok Crescent #29-84 Wcega Tower Singapore 658065</li>
                                    <li><span class="icon fa fa-phone"></span> Phone: (65) 1234 5678</li>
                                    <li><span class="icon fa fa-envelope-o"></span> Email: laurencelys@gmail.com</li>
                                    <li><span class="icon fa fa-fax"></span> Fax: (65) 1234 5678</li>
                                 </ul>
                              ...
                              <div class="footer-widget news-widget">
                                 ...
                                 <div class="news-post">
                                    ...
                                    <div class="news-content">
                                       ...
                                       <figure class="image-thumb"><img alt=""   src="{{ url("/adforest/images/blog/popular-2.jpg") }}"></figure>
                                 ...
                                 <div class="news-post">
                                    <div class="icon"></div>
                                    <div class="news-content">
                                       <figure class="image-thumb"><img alt="" src="{{ url("/adforest/images/blog/popular-1.jpg") }}"></figure>
                                       <a href="#">If you need a crown or lorem an implant you will pay it gap it</a>
                                    </div>
                                    <div class="time">July 2, 2014</div>
                                 </div>
            ...
            <div class="footer-copyright">
               <div class="container clearfix">
                  <!--Copyright-->
                  <div class="copyright text-center">Copyright 2017 © SME Consult Hub All Rights Reserved</div>
               </div>
            </div>
         </footer>
</div>
