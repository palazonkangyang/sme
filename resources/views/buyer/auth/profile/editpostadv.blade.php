                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body" style="padding: 0 20px">
                                        ...
                                        <div class="col-md-10">
                                           <select id="category_id" name="category_id" value= class="form-control">
                                                @foreach($category as $cat)
                                                    <option name='category_id' value="{{$cat->id}}" <?php if ($postadv['category_id'] == $cat->id) echo "selected"; ?>>{{$cat->service_category}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group {!! $errors->has('phone') ? ' has-error' : '' !!}">
                                        ...
                                        <div class="col-md-10">
                                            {!! Form::text("phone", $postadv['phone'], ["class" => "form-control"]) !!}
                                        </div>
                                    ...
                                    <div class="form-group {!! $errors->has('description') ? ' has-error' : '' !!}">
                                        ...
                                        <div class="col-md-10">
                                            {!! Form::textarea("description", $postadv['description'], ["class" => "form-control ckeditor"]) !!}
                                        </div>
                                        <p class="help-block"></p>
                                    </div><!-- end form-group -->
