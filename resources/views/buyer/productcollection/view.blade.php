                           ...
                           <?php $i = 1; ?>
                            ...
                            @foreach($items as $key=>$item)
                                <tr>
                                    ...
                                    <td>{{ $status }}</td>
                                    <td> <a style="visibility: visible;" href="{!! route("buyer.collection.product.edit",[$item->id]) !!}"><i
                                                    class="fa fa-edit" ></i> Action</a></td>
                                    @else
                                    <?php $status = 'Not Collected';?>
                                    <td>{{ $status }}</td>
                                    <td> <a style="visibility: visible;" href="{!! route("buyer.collection.product.verification.post",[$item->id]) !!}"><i
                                                    class="fa fa-edit" ></i> Action</a></td>
                                    @endif                                                                                                            
