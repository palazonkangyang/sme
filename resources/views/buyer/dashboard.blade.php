            ...
            <div class="container">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="box">
                        <img alt="img" src= {!! url("uploads/Service_Categories/$cate->image")!!} >
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-12">
                     <div class="parallex-button"> <a href="posting" class="btn btn-theme">Post Ad <i class="fa fa-angle-double-right "></i></a> </div>
                     <!-- end parallex-button -->
                  </div>
                  <!-- end col-md-4 -->
               </div>
