                ...
                @if($items->count() > 0)
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>#</td>
                                <th>{!! ListView::sortColumn("Service Category", "service_category") !!}</th>
                                <th>{!! ListView::sortColumn("Parent", "parent_id") !!}</th>
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->service_category }} <br/>
                                        <a href="{!! route("admin.service_category.edit", [$item->id]) !!}"><i
                                                    class="fa fa-edit"></i> Edit</a>

                                        
                                            &nbsp;&nbsp;<a class="delete-confirm"
                                                           href="{!! route("admin.service_category.delete", [$item->id]) . "?_token=" . csrf_token() !!}"><i
