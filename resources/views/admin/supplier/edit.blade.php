...
@section('content')
    ...
    {!! Form::open(["url" => route("admin.supplier.update", $supplier->id)]) !!}
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group{!! $errors->has("email") ? " has-error" : "" !!}">
                        {!! Form::label("Email") !!}
                        {!! Form::text("email", Input::old("email", $supplier->email), ["class" => "form-control"]) !!}
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="form-group{!! $errors->has("spe_ticket_price") ? " has-error" : "" !!}">
                        ...
                        {!! Form::text("spe_ticket_price", Input::old("spe_ticket_price", $supplier->spe_ticket_price), ["class" => "form-control", "autocomplete" => "off"]) !!}
                        <p class="help-block">{{ $errors->first("spe_ticket_price") }}</p>
                    </div>

                    <div class="form-group{!! $errors->has("status") ? " has-error" : "" !!}">
                        {!! Form::label("User Status") !!}
                        {!! Form::select("status", ["" => "Select:"] + $supplier->allStatuses(), Input::old("status", $supplier->status), ["class" => "form-control"]) !!}
                        <p class="help-block">{{ $errors->first("status") }}</p>
                    </div>
                     <div class="form-group{!! $errors->has("featured") ? " has-error" : "" !!}">
                        {!! Form::label("Featured") !!}
                        {!! Form::select("featured", ["" => "Select:"] + $supplier->allFeatures(), Input::old("featured", $supplier->featured), ["class" => "form-control"]) !!}
