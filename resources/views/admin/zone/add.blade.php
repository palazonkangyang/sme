...
@section('content')
    ...
    {!! Form::open(["route" => "admin.zone.store", "files" => true]) !!}
  <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group{!! $errors->has("zone") ? " has-error" : "" !!}">
                                ...
                                {!! Form::text("zone", Input::old("zone"), ["class" => "form-control"]) !!}
                        ...
                        {!! Form::label("Status") !!}
                        {!! Form::select("status", ["" => "Select:"] + $zone->allStatuses(), Input::old("status",'1'), ["class" => "form-control"]) !!}
