                ...
                @if($items->count() > 0)
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>#</td>
                                <th>{!! ListView::sortColumn("Feature", "adv_feature") !!}</th>
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->adv_feature }} <br/>
                                        <a href="{!! route("admin.adv_feature.edit", [$item->id]) !!}"><i
                                                    class="fa fa-edit"></i> Edit</a>

                                        
                                            &nbsp;&nbsp;<a class="delete-confirm"
                                                           href="{!! route("admin.adv_feature.delete", [$item->id]) . "?_token=" . csrf_token() !!}"><i
