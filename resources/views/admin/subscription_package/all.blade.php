                ...
                @if($items->count() > 0)
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>#</td>
                                <th>{!! ListView::sortColumn("Subscription Package Name", "subscription_package") !!}</th>
                                <th>{!! ListView::sortColumn("Subscription Price", "subscription_price") !!}</th>
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->subscription_package }} <br/>
                                        <a href="{!! route("admin.subscription_package.edit", [$item->id]) !!}"><i
                                                    class="fa fa-edit"></i> Edit</a>

                                        
                                            &nbsp;&nbsp;<a class="delete-confirm"
                                                           href="{!! route("admin.subscription_package.delete", [$item->id]) . "?_token=" . csrf_token() !!}"><i
