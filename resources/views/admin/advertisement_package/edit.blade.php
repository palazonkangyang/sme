...
@section('content')
    ...
    {!! Form::open(["url" => route("admin.advertisement_package.update", $advertisement_package->id), "files" => true]) !!}
  <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group{!! $errors->has("advertisement_package") ? " has-error" : "" !!}">
                                ...
                                {!! Form::text("advertisement_package", Input::old("advertisement_package", $advertisement_package->advertisement_package), ["class" => "form-control"]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group{!! $errors->has("advertisement_price") ? " has-error" : "" !!}">
                                ...
                                {!! Form::text("advertisement_price", Input::old("advertisement_price",$advertisement_package->advertisement_price), ["class" => "form-control"]) !!}
                        ...
                        {!! Form::label("Status") !!}
                        {!! Form::select("status", ["" => "Select:"] + $advertisement_package->allStatuses(), Input::old("status",$advertisement_package->status), ["class" => "form-control"]) !!}
