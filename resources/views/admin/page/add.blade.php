            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group{!! $errors->has("content") ? " has-error" : "" !!}">
                        {!! Form::label("Content") !!}
                        {!! Form::textarea("content", Input::old("content"), ["class" => "form-control", "id" => "editor"]) !!}
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group{!! $errors->has("banner_title") ? " has-error" : "" !!}">
                        ...
                        {!! Form::text("banner_title", Input::old("banner_title"), ["class" => "form-control"]) !!}
                    ...
                    <div class="form-group{!! $errors->has("banner_sub_title") ? " has-error" : "" !!}">
                        ...
                        {!! Form::text("banner_sub_title", Input::old("banner_sub_title"), ["class" => "form-control"]) !!}
                    ...
                    <div class="form-group{!! $errors->has("banner_button_url") ? " has-error" : "" !!}">
                        ...
                        {!! Form::text("banner_button_url", Input::old("banner_button_url"), ["class" => "form-control"]) !!}
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group{!! $errors->has("meta_keywords") ? " has-error" : "" !!}">
                        ...
                        {!! Form::textarea("meta_keywords", Input::old("meta_keywords"), ["class" => "form-control", "rows" => 3]) !!}
                        <p class="help-block">{{ $errors->first("meta_keywords") }}</p>
                    </div>

                    <div class="form-group{!! $errors->has("meta_description") ? " has-error" : "" !!}">
                        {!! Form::label("Meta Description") !!}
                        {!! Form::textarea("meta_description", Input::old("meta_description"), ["class" => "form-control", "rows" => 3]) !!}
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group{!! $errors->has("template") ? " has-error" : "" !!}">
                        ...
                        {!! Form::select("template", ["" => "Select:"] + $page->pageTemplates(), Input::old("status"), ["class" => "form-control"]) !!}
                        <p class="help-block">{{ $errors->first("template") }}</p>
                    </div>

                    <div class="form-group{!! $errors->has("status") ? " has-error" : "" !!}">
                        {!! Form::label("Status") !!}
                        {!! Form::select("status", ["" => "Select:"] + $page->allStatuses(), Input::old("status"), ["class" => "form-control"]) !!}
