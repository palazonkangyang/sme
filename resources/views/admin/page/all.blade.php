                ...
                @if($items->count() > 0)
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>#</td>
                                <th>{!! ListView::sortColumn("Name", "name") !!}</th>
                                <th>{!! ListView::sortColumn("Code", "code") !!}</th>
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->name }} <br/>
                                        <a href="{!! route("admin.page.edit", [$item->id]) !!}"><i
                                                    class="fa fa-edit"></i> Edit</a>

                                        @if($item->role !==0)
                                            &nbsp;&nbsp;<a class="delete-confirm"
                                                           href="{!! route("admin.page.delete", [$item->id]) . "?_token=" . csrf_token() !!}"><i
