            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group{!! $errors->has("password") ? " has-error" : "" !!}">
                        ...
                        <p class="text-muted">Enter new Password, If you wish to change it.</p>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="form-group{!! $errors->has("role") ? " has-error" : "" !!}">
                        ...
                        {!! Form::select("role", ["" => "Select:"] + $user->getRoleTypes(), Input::old("role",'1'), ["class" => "form-control"]) !!}
                        <p class="help-block">{{ $errors->first("role") }}</p>
                    </div>

                    <div class="form-group{!! $errors->has("status") ? " has-error" : "" !!}">
                        {!! Form::label("User Status") !!}
                        {!! Form::select("status", ["" => "Select:"] + $user->getStatuses(), Input::old("status",'1'), ["class" => "form-control"]) !!}
                        <p class="help-block">{{ $errors->first("status") }}</p>
                    </div>
                </div>

                <div class="box-footer">
                    {!! Html::link(Route("admin.account.all"), "Cancel", ["class" => "btn btn-default pull-left"]) !!}
